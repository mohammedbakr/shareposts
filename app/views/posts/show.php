<?php require APPROOT .'/views/inc/header.php'; ?>
  <a href="<?php echo URLROOT; ?>/posts" class="btn btn-light mb-3">
    <i class="fa fa-backward"></i> Back
  </a>
  <h1><?php echo $data['post']->title; ?></h1>
  <div class="bg-light p-2 mb-3">
    written by <span class="text-muted"><?php echo $data['user']->name; ?></span> on <span class="text-muted"><?php echo $data['post']->created_at; ?></span>
  </div>
